...
namespace Dreamwing.UI
{
	/// <summary>
	/// Turn a simple label into a interactable input field.
	/// </summary>

	[AddComponentMenu("UI/Dreamwing/Custom Input Field")]
		...
		ILayoutElement
	{
		...
		virtual protected EditState KeyPressed(Event evt)
		{
		...
		private void MoveRight(bool shift, bool ctrl)
		{
			...
			// DREAMWING
			int lastPosition = caretPositionInternal;
			...
			// DREAMWING - if at end, change selection
			if (!ctrl && !shift && lastPosition == caretPositionInternal)
			{
				NavigateTo(FindSelectableOnRight());
			}
		}
		...
		private void MoveLeft(bool shift, bool ctrl)
		{
			...
			if (!ctrl && !shift && lastPosition == caretPositionInternal)
			{
				NavigateTo(FindSelectableOnLeft());
			}
		}
		...
		private void MoveDown(bool shift, bool goToLastChar)
		{
			...
			// DREAMWING - if at end, change selection
			if (!shift && lastPosition == caretPositionInternal)
			{
				NavigateTo(FindSelectableOnDown());
			}
		}
		...
		// DREAMWING
		private void NavigateTo(Selectable uiElement)
		{
			if (uiElement == null || !uiElement.gameObject.activeInHierarchy)
				return;
